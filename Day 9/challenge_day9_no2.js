...
const new_country = countries_2023.map((country) => country.name);

function categorizeCountries(countries, pattern) {
  return countries.filter((country) => country.includes(pattern));
}

//console.log(categorizeCountries(new_country, "land"));
//console.log(categorizeCountries(new_country, "ia"));
//console.log(categorizeCountries(new_country, "island"));
//console.log(categorizeCountries(new_country, "stan"));

// 4. Create a function which return an array of objects, which is the letter and the number of times the letter use to start with a name of a country.

function countCountries(countries) {
  const letters = countries.map((country) => country[0]);
  const uniqueLetters = new Set(letters);
  const result = [];
  uniqueLetters.forEach((letter) => {
    const obj = {};
    obj["letter"] = letter;
    obj["count"] = letters.filter((l) => l === letter).length;
    result.push(obj);
  });
  return result;
}

console.log(countCountries(new_country));
...
console.log(getFirstTenCountries(new_country));
...
console.log(getLastTenCountries(new_country));

// 7. Find out which letter is used many times as initial for a country name from the countries array (eg. Finland, Fiji, France etc)

function mostFrequentLetter(countries) {
  const letters = countries.map((country) => country[0]);
  const uniqueLetters = new Set(letters);
  const result = [];
  uniqueLetters.forEach((letter) => {
...
console.log(mostFrequentLetter(new_country));
