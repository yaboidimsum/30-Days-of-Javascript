...
function mostPopulatedCountries(countries, n) {
  ...
  countries.forEach((country) => {
    countries_population.push({
      country: country.name,
      population: country.population,
    });
  });
  countries_population.sort((a, b) => b.population - a.population);
  return countries_population.slice(0, n);
}
...
Object.prototype.mean = function() {
    return this.sum() / this.count();
}

Object.prototype.median = function() {
...
Object.prototype.mode = function() {
    let mode = 0;
    let count = 0;
    let modes = [];
    ...
    return { mode: modes, count: mode };
}

Object.prototype.var = function() {
    let mean = this.mean();
    let sum = 0;
    this.forEach((num) => {
        sum += (num - mean) ** 2;
...
Object.prototype.std = function() {
    return Math.sqrt(this.var());
}

Object.prototype.freqDist = function() {
    let freq = {};
    this.forEach((num) => {
        if (freq[num]) {
            freq[num]++;
